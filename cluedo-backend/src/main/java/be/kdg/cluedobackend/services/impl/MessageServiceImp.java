...
public class MessageServiceImp implements MessageService {
    ...
    @Override
    public List<Message> getMessages(Integer cluedoId) throws CluedoException {
        Optional<Cluedo> cluedo = cluedoRepository.findById(cluedoId);
        if (cluedo.isEmpty()) throw new CluedoException(CluedoExceptionType.CLUEDO_NOT_FOUND);
        return cluedo.get().getMessages();
    }
